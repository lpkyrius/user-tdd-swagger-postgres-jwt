...
userRouter.post('/user/logout'    , verifyJWT, async (req: Request, res: Response) => await (await userFactory()).handleLogout(req, res));
userRouter.post('/user/refresh'   , verifyJWT, async (req: Request, res: Response) => await (await userFactory()).httpRefreshToken(req, res));
